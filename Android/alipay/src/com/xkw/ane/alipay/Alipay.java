...
public class Alipay {
	...
	public Alipay(Activity activity) {
		...
		PARTNER = getMetaData("PARTNER").substring(0, 16);
		SELLER = getMetaData("SELLER");
		RSA_PRIVATE = getMetaData("RSA_PRIVATE");
		RSA_PUBLIC = getMetaData("RSA_PUBLIC");
	}
	 ...
	 * @return
	 */
	public String pay(String outTradNo, String productName, String productDes, String price, String notifyUrl) {
		// 订单
		String orderInfo = getOrderInfo(outTradNo, productName, productDes, price, notifyUrl);
		...
		return "call pay method success"
//				+ "\n\nPARTNER="+PARTNER
//				+ "\n\norderInfo="+orderInfo
//				+ "\n\nsign="+sign
//				+ "\n\noutTradNo="+outTradNo
